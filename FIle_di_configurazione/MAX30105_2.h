...
uint8_t begin(TwoWire &wirePort = Wire, uint32_t i2cSpeed = I2C_SPEED_STANDARD, uint8_t i2caddr = MAX30105_ADDRESS);
...
//int sampleRate = 400, int pulseWidth = 411
void setup(byte powerLevel = 0x1F, byte sampleAverage = 4, byte ledMode = 3, int sampleRate = 3200, int pulseWidth = 217, int adcRange = 4095);
